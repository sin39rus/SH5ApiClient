...
namespace SH5ApiClient.Models.DTO.Tests
{
    ...
    public class GDoc11Tests
    {
        ...
        public void ParseGDoc11Test()
        {
            ...
            Assert.AreEqual(item1.Product.Rid, (uint)3);
            Assert.AreEqual(item1.Product.Name, "Товар №1");
            ...
            Assert.AreEqual(item1.Product.MeasureUnit.Rid, (uint)5);
            Assert.AreEqual(item1.Product.MeasureUnit.Name, "шт.");
            ...
            Assert.AreEqual(item2.Product.Rid, (uint)4);
            Assert.AreEqual(item2.Product.Name, "Товар №2");
            ...
            Assert.AreEqual(item2.Product.MeasureUnit.Rid, (uint)4);
            Assert.AreEqual(item2.Product.MeasureUnit.Name, "Литр");
