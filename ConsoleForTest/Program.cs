...
namespace ConsoleForTest
{
    internal class Program
    {
        static void Main()
        {
            ...
            var correspondents = client.LoadGDocsAsync(new DateTime(2020, 1, 1), new DateTime(2023, 1, 1), SH5ApiClient.Models.Enums.TTNTypeForRequest.InternalMovement).Result.ToList();
